...
public class MainClass {
    public static void main(String[] args) {
        ...
        Vehicle smart = new Car(50, "Smart");

        System.out.println(jeep.move() + " " + jeep.getModel() + " and accelerate to " + jeep.speedUp(50) + " km/h then " + jeep.applyBreak() + " and " + jeep.stop());
        System.out.println(smart.move() + " " + smart.getModel() + " and accelerate to " + smart.speedUp(40) + " km/h then " + smart.applyBreak() + " and " + smart.stop());
        System.out.println();
